...
namespace KanbanProject
{
   ...
   /*     static void Main(string[] args)
        ...
        private static int ValidNumber(string number)//checks if the string contains a valid number
        {
        ...
        public static void RemoveTask(int task)
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Log.Warn("Task removing failed, the task Id does not exist.");
                Console.ResetColor();
                UserOption();
            }
        ...
        public static void EditTaskChooseOption(int taskId)
        {
            ...
            Console.WriteLine("Choose only one option :");
            Console.ResetColor();
            Console.WriteLine("1. TaskTitle ");
            Console.WriteLine("2. TaskDescription");
            Console.WriteLine("3. TaskDueDate\n");
            ...
            if (userChoise.Length == 1) // if the length of the option that the user entered is correct
            {
                switch (userChoise)
                {
                    case "1": // in case the user wants to register
                        ...
                        string title = Console.ReadLine();
                        DateTime defualt = DateTime.Parse("1/1/20") ;
                        EditTask(taskId, title, null, defualt);
                    ...
                    case "2": // in case the user wants to login
                        ...
                        defualt = DateTime.Parse("1/1/20");
                        EditTask(taskId, null, description, defualt);
